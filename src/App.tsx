...
const PROJECTS_DATA = [
  {
    ...
    description: "Quickly remove backgrounds from images with this easy-to-use web tool. Get clean, transparent results in just a few clicks.",
    image: "https://i.ibb.co.com/hF1NY42/Screenshot-2025-01-11-021335.png",
    github: "https://github.com/raflyazwar/backround-remover",
    demo: "https://backroundremover.netlify.app/"
  },
  {
    id: 2,
    title: "Social Media Downloader",
    description: "Download videos and images from social media platforms with ease. Save your favorite content for offline use.",
    image: "https://i.ibb.co.com/7vPRyv7/Screenshot-2025-01-11-010701.png",
    github: "https://github.com/raflyazwar/social-media-downloader",
    demo: "https://socia-media-downloader-hd.netlify.app"
  },
  {
    id: 3,
    title: "Password Manager",
    description: "Store and manage your passwords securely with this easy-to-use web tool. Keep your login information safe and organized.",
    image: "https://i.ibb.co.com/5cXKKxp/Screenshot-2025-01-11-013849.png",
    github: "https://github.com/raflyazwar/password-manager",
    demo: "https://password-manager-save-your-password.netlify.app/"
  },
];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://github.com/raflyazwar" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700">
                  <Github className="w-6 h-6" />
                </a>
                <a href="#" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="#" className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700">
        ...
        <footer className="bg-white dark:bg-gray-900 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center text-gray-600 dark:text-gray-400">
              <p>© 2024 Rafly Azwar. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
